/**
 * Общий язык и тема для index.html и demo.html
 */
...
const SITE_TRANSLATIONS = {
  landing: {
    ru: {
      ...
      heroLead: "KindHub объединяет фонды, волонтёров, обычных людей и тех, кому нужна помощь, в одном понятном пространстве с доверием и реальными сценариями поддержки.",
      ...
      cardVolText: "Волонтёры из фондов получают более глубокий уровень доверия и могут помогать в важных задачах.",
      cardPeople: "Для обычных людей",
      cardPeopleText: "Пользователи формата «Безвоздмездник» помогают рядом или удалённо, например по звонку незрячим.",
      cardHelp: "Для тех, кому нужна помощь",
      cardHelpText: "Создание запросов с указанием места на карте, разные категории помощи, поддержка незрячих по звонку и связь с волонтёрами.",
    ...
    en: {
      ...
      heroLead: "KindHub brings together foundations, volunteers, everyday helpers, and people who need support — one clear space built on trust and real support scenarios.",
      ...
      cardVolText: "Volunteers linked to foundations gain deeper trust and can take on more impactful tasks.",
      cardPeople: "For everyday helpers",
      cardPeopleText: "«Benefactors» help nearby or remotely — for example by calling to assist blind users.",
      cardHelp: "For those who need help",
      cardHelpText: "Create requests by marking locations on map, various help categories, support for blind users, and connection with verified helpers.",
    ...
    kg: {
      ...
      heroLead: "KindHub фонддорду, ыктыярчыларды, кадимки адамдарды жана жардамга муктаждарды бир эле түшүнүктүү мейкиндикте бириктирет — ишеним жана реалдуу сценарийлер менен.",
      ...
      cardVolText: "Фонд менен байланышкан ыктыярчылар тереңирээк ишенимге ээ болуп, маанилүү тапшырмаларды аткарат.",
      cardPeople: "Кадимки адамдар үчүн",
      cardPeopleText: "«Кайрымдуулар» жакын жерден же алыстан жардам көрсөтүшөт — мисалы, көрүүсү начарларга чакырык менен.",
      cardHelp: "Жардамга муктаждар үчүн",
      cardHelpText: "Картада жерин көрсөтүп суроостарды түзүү, ар түрдүү жардам категориялары, көрүүсү начарларга телефон аркылуу колдоо жана ыктыярчылар менен байланыш.",
  ...
  demo: {
    ru: {
      ...
      lead: "В MVP предусмотрено 4 роли. Нажмите на карточку для перехода на отдельный экран регистрации и функций.",
      role1t: "Как фонд",
      ...
      noteText: "Теперь у каждой роли отдельный файл. Там доступны регистрация, задачи, карта и определение местоположения."
    },
    en: {
      themeDark: "Dark theme",
      themeLight: "Light theme",
      ...
      lead: "The MVP has 4 roles. Tap a card to open a dedicated registration and features screen.",
      ...
      noteText: "Each role now has its own page with registration, tasks, map, and geolocation."
    },
    kg: {
      themeDark: "Кара тема",
      themeLight: "Жарык тема",
      ...
      lead: "MVPда 4 роль бар. Каттоо жана функциялар үчүн өзүнчө экран ачуу үчүн картага баскыла.",
      role1t: "Фонд катары",
      ...
      noteText: "Ар бир ролдун өз барагы бар: каттоо, тапшырмалар, карта жана геолокация."
    }
  }
};
...
function siteT(page, lang, key) {
  ...
  if (!pack || !pack[lang] || !pack[lang][key]) {
    return SITE_TRANSLATIONS[page].ru[key] || key;
  }
